...
export const CORPORATE_PROGRAM_PAGES: Record<CorporateProgramSlug, CorporateProgramPageData> = {
  sahyog: {
    ...
    title: "SAHYOG",
    hero: {
      banner: `${T}/corporate/prayog/banner.jpg`,
    ...
    pillars: [
      { title: "Pranayama", image: `${T}/corporate/prayog/pranayama.jpg` },
      { title: "Aasana", image: `${T}/corporate/prayog/aasna.jpg` },
      { title: "Yoga", image: `${T}/corporate/prayog/yoga.jpg` }
    ],
    sections: [
      {
        ...
        image: `${T}/corporate/prayog/pranayama_1.jpg`,
        imagePosition: "right",
        background: "#F2FAF8"
      },
      {
        ...
        image: `${T}/corporate/prayog/aasna_1.jpg`,
        imagePosition: "left",
        background: "#FFF2E9"
      },
      {
        ...
        image: `${T}/corporate/prayog/yoga_1.jpg`,
        imagePosition: "right",
        background: "#F2FAF8"
      }
    ]
  ...
  sargam: {
    ...
    title: "SARGAM",
    hero: {
      banner: `${T}/corporate/vibe/banner.jpg`,
      subtitle:
    ...
    pillars: [
      { title: "Sound Therapy", image: `${T}/corporate/vibe/soundbath.jpg` },
      { title: "Drum Circle", image: `${T}/corporate/vibe/drumcircle.jpg` }
    ],
    sections: [
      {
        title: "Sound Therapy",
        body: "Our simple yet powerful techniques such as sound therapy sessions, sound baths, immersive music experiments and drum circles help support employees in building unity, reducing anxiety, and boosting positivity. By boosting energy levels and reducing fatigue, we create a more productive and harmonious work environment.",
        image: `${T}/corporate/vibe/image2.jpg`,
        imagePosition: "left",
        background: "#FFF2E9"
      },
      {
        ...
        image: `${T}/corporate/vibe/image1.jpg`,
        imagePosition: "right",
        background: "#F2FAF8"
      }
    ]
  ...
  samatva: {
    ...
    title: "SAMATVA",
    hero: {
      banner: `${T}/corporate/fares/banner.jpg`,
      subtitle:
    ...
    pillars: [
      { title: "Focus", image: `${T}/corporate/fares/focus.jpg` },
      { title: "Awareness", image: `${T}/corporate/fares/awareness.jpg` },
      { title: "Resilience", image: `${T}/corporate/fares/resilience.jpg` },
      { title: "Expression", image: `${T}/corporate/fares/expression.jpg` },
      { title: "Synergy/Collaboration", image: `${T}/corporate/fares/collaboration.jpg` }
    ],
    sections: [
      {
        title: "Focus",
        ...
        image: `${T}/corporate/fares/focus_1.jpg`,
        imagePosition: "right",
        background: "#F2FAF8"
      },
      {
        ...
        image: `${T}/corporate/fares/awareness_1.jpg`,
        imagePosition: "left",
        background: "#FFF2E9"
      },
      {
        ...
        image: `${T}/corporate/fares/resilience_1.jpg`,
        imagePosition: "right",
        background: "#F2FAF8"
      },
      {
        ...
        image: `${T}/corporate/fares/expression_1.jpg`,
        imagePosition: "left",
        background: "#FFF2E9"
      },
      {
        ...
        image: `${T}/corporate/fares/collaboration_1.jpg`,
        imagePosition: "right",
        background: "#F2FAF8"
      }
    ]
  ...
  samsara: {
    ...
    title: "SAMSARA",
    hero: {
      banner: `${T}/corporate/earth/banner.jpg`,
    ...
    pillars: [
      { title: "Art Therapy", image: `${T}/corporate/earth/art.jpg` },
      { title: "Expression", image: `${T}/corporate/earth/expression.jpg` },
      { title: "Movement", image: `${T}/corporate/earth/sharing.jpg` }
    ],
    quoteBlock: {
      title:
    ...
    sections: [
      {
        ...
        image: `${T}/corporate/earth/art_1.jpg`,
        imagePosition: "right",
        background: "#F2FAF8"
      },
      {
        ...
        image: `${T}/corporate/earth/expression_1.jpg`,
        imagePosition: "left",
        background: "#FFF2E9"
      },
      {
        ...
        image: `${T}/corporate/earth/sharing_1.jpg`,
        imagePosition: "right",
        background: "#F2FAF8"
      }
    ]
