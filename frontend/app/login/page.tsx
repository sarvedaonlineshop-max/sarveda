...
const inputClass =
  "w-full rounded-full border border-[#E3D9C8] bg-white/88 px-4 py-3 font-sans text-brand-ink shadow-[inset_0_1px_0_rgba(255,255,255,0.65)] placeholder:text-brand-ink/42 transition focus:border-[#5fbe48] focus:bg-white focus:outline-none focus:ring-4 focus:ring-[#5fbe48]/18";
