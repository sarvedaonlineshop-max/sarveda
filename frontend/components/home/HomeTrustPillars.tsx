 ...
 * Mobile: text + pillars first, image below. Desktop: two columns, shorter photo.
 */
  ...
  return (
    ...
    >
      <div className="page-shell pb-8 pt-3 sm:pb-10 sm:pt-4 md:pb-12 md:pt-6 lg:pb-14 lg:pt-8">
        <div className="grid grid-cols-1 items-start gap-6 md:grid-cols-2 md:gap-8 lg:items-center lg:gap-12">
          ...
          <div className="relative min-w-0 md:self-center">
            <div className="relative aspect-[16/10] overflow-hidden rounded-2xl sm:aspect-[2/1] md:aspect-[5/2] md:max-h-[11.5rem] lg:max-h-[13rem] lg:rounded-[1.75rem]">
              <Image
