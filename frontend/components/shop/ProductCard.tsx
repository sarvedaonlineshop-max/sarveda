        ...
        >
          {activeImage ? (
            <Image
              ...
              alt={product.name}
              fill
              // Serve S3/CDN URLs directly. Vercel Image Optimization returns 402 once
              // the monthly transform quota is hit, which blanked many store tiles while
              // the originals were still fine on S3 (PDP already uses unoptimized).
              unoptimized
