...
export function AuthShell({
  ...
  return (
    <div className="relative min-h-dvh overflow-hidden bg-[#f7f0e6] font-sans text-[#10201a] lg:min-h-screen">
      <div
        ...
        aria-hidden="true"
      />
      <div className="pointer-events-none absolute inset-0 hidden bg-white/5 lg:block" aria-hidden="true" />

      <div className="relative hidden min-h-screen w-full lg:block">
        <section className="absolute left-[53.8%] top-1/2 w-[30.6rem] -translate-y-1/2 xl:left-[54.2%] xl:w-[31.6rem] 2xl:left-[54.7%]">
          <div className="rounded-[1.65rem] border border-white/85 bg-white/96 px-9 py-10 shadow-[0_30px_90px_rgba(28,53,42,0.18)] backdrop-blur-xl">
            <div className="text-left">
              <h1 className="font-serif text-[2.55rem] font-semibold leading-tight tracking-[-0.055em] text-[#10201a]">
                {title}
              </h1>
