            ...
            <div className="min-h-0 flex-1 overflow-auto p-3">
              ...
              {busy && items.length === 0 ? (
                ...
                <table className="min-w-full text-left text-sm">
                  <thead className="text-[11px] font-bold uppercase tracking-wide text-stone-400">
                    <tr>
                      <th className="px-2 py-2">Date &amp; time</th>
                      <th className="px-2 py-2">Notes</th>
                      <th className="px-2 py-2">Attended by</th>
                    ...
                    {items.map((row) => {
                      ...
                      return (
                        <tr key={row.id} className="border-t border-stone-100 align-top">
                          ...
                          <td className="max-w-[14rem] px-2 py-2.5 text-stone-700">
